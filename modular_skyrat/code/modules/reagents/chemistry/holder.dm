	...
	if(can_overdose)
		if(addiction_tick == 6)
			...
			for(var/addiction in cached_addictions)
				...
				if(C && R)
					R.addiction_stage++
					if(R.addiction_stage >= 1 && R.addiction_stage <= R.addiction_stage1_end)
						need_mob_update += R.addiction_act_stage1(C)
					else if(R.addiction_stage <= R.addiction_stage2_end)
						need_mob_update += R.addiction_act_stage2(C)
					else if(R.addiction_stage <= R.addiction_stage3_end)
						need_mob_update += R.addiction_act_stage3(C)
					else if(R.addiction_stage <= R.addiction_stage4_end)
